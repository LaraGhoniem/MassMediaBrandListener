...
class AsrHandler:
    ...
    def __init__(self, keyword, platform):
        self.YOUTUBE_DOWNLOADS_PATH = "youtube/downloads"
        self.PODCASTS_DOWNLOADS_PATH = "podcasts/PodcastsMP3"
        self.keyword = keyword
        self.platform = platform
        self.YOUTUBE_PREPROCESSED_DATA_PATH = "ASR_Model/processed_audio_files/YouTube"
        self.YOUTUBE_TRIMMED_DATA_PATH = "ASR_Model/result_trim/YouTube"
        self.PODCASTS_PREPROCESSED_DATA_PATH = "ASR_Model/processed_audio_files/Podcasts"
        self.PODCASTS_TRIMMED_DATA_PATH = "ASR_Model/result_trim/Podcasts"
    def preprocess(self):
        sourcepath = ""
        destpath = ""
        ...
        for keyword in os.listdir(sourcepath):
            ...
            for filename in os.listdir(keywordPath):
                ...
                print(f'ffmpeg -i {src} -ac 1 -ar 22050 {dest}')
                res.stdout.read()
    def trim(self):
