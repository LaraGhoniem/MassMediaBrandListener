...
class Spam:
    def __init__(self):
        ...
        with open('cloud_function/modules/preprocessing_module/spam_detection/tweet_spam_filter_arabic.pkl', 'rb') as f:
            self.model = pickle.load(f)
        with open('cloud_function/modules/preprocessing_module/spam_detection/tweet_spam_vectorizer_arabic.pkl', 'rb') as f:
